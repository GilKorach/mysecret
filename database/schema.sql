...
CREATE TABLE IF NOT EXISTS secrets (
  ...
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  KEY idx_secrets_feed_visibility (is_deleted, user_id, created_at),
  KEY idx_secrets_feed_recent (is_deleted, created_at, id),
  KEY idx_secrets_slug (id, slug),
...
CREATE TABLE IF NOT EXISTS comments (
  ...
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
  KEY idx_comments_secret_tree_created (secret_id, parent_id, is_deleted, created_at),
...
CREATE TABLE IF NOT EXISTS comment_reactions (
  ...
  KEY idx_comment_reactions_comment_created (comment_id, created_at),
...
CREATE TABLE IF NOT EXISTS followers (
  ...
  KEY idx_followers_follower_created (follower_id, created_at),
...
CREATE TABLE IF NOT EXISTS blocked_users (
  ...
  KEY idx_blocked_users_blocker_created (blocker_id, created_at),
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  KEY idx_notifications_secret_id (secret_id),
